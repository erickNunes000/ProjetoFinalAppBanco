...
abstract class Conta {
    ...
    private boolean solicitouEmprestino=false;
    ...
    public boolean getSolicitouEmprestimo(){
        return this.solicitouEmprestino;
    }
    public void setSolicitouEmprestino(boolean solicitouEmprestino){
        this.solicitouEmprestino=solicitouEmprestino;
    }
   ...
   public String infoConta(){
       return "Titular: "+ this.getTitular()+"CPf "+this.getCpf()+"Agencia: "+this.getAgencia()+"Solicitou emprestimo "+this.getSolicitouEmprestimo();
   }
}
